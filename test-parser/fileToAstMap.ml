...
let createTable  = 
   ...
   Hashtbl.add fileToAstMap "exp8.k" {ast = [Function(Id "foo",[], [Assign (Id "id", Minus(Plus(Int 4, Int 5),Int 3), IdExp(Id "id"))])]  ;formatString = "id = 4+5-3 should be parsed correctly  Assign (Id \"id\", Minus(Plus(Int 4, Int 5),Int 3), IdExp(Id \"id\")):";};
   ...
   Hashtbl.add fileToAstMap "exp10.k" {ast = [Function(Id "foo", [], [Assign(Id "x",Plus(Plus(Minus(Plus(Write (IdExp (Id "z")),Int 13),Times(Int 25,Int 6)),Read (Id "q")),Write (Int 5)), IdExp(Id "x"))])]  ;formatString = "let x =print z + 13 - 25*6 + read q + print 5 in x should be parsed Assign(Id \"x\",Minus(Plus(Write (IdExp (Id \"z\")),Int 13),Plus(Plus(Times(Int 25,Int 6),Read (Id \"q\")),Write (Int 5)))):";};
